 ...
 * associated with a UCI. <p>The message is dispatched to a specified remote
 * {@link se.mediasense.disseminationlayer.communication.MediaSenseHost}.
 ...
 * MsgType) as <i>se.mediasense.messages.ResolveMessage</i> or by using the
 * defaultlistener.
 */
public final class DuplicateUCICheckMessage extends MediaSenseMessage implements Serializable
{

    private final String uci;
    public static final String TYPE = DuplicateUCICheckMessage.class.getName();
     ...
     * being requested
     * @param _requester - The
     * {@link se.mediasense.disseminationlayer.communication.MediaSenseHost}
     */
    public DuplicateUCICheckMessage(String _uci, MediaSenseHost _requester)
    {
        super(_requester, _requester, DuplicateUCICheckMessage.TYPE);
     ...
     */
    public DuplicateUCICheckMessage(String _uci, MediaSenseHost _requester, String _MsgID)
    {
        super(_requester, _requester, _MsgID, DuplicateUCICheckMessage.TYPE);
