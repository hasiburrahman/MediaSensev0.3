...
public final class DeleteMessage extends MediaSenseMessage
{
	
	private final UCI uci;
        public static final String TYPE = DeleteMessage.class.getName();
     ...
     */
        public DeleteMessage(UCI _uci, MediaSenseHost _destination, MediaSenseHost _requestor)
        {
               super(_destination, _requestor, DeleteMessage.TYPE);
     ...
     */
        public DeleteMessage(UCI _uci, MediaSenseHost _destination, MediaSenseHost _requestor,  String _MsgID)
        {
               super(_destination, _requestor, _MsgID, DeleteMessage.TYPE);
