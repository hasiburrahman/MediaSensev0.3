...
public interface MediaSenseListener 
{
        public final String listenerid = MediaSenseID.generateID();

        /**
         * The callback for processing the {@link se.mediasense.messages.MediaSenseMessage}
         * @param _msg the {@link se.mediasense.messages.MediaSenseMessage} to be processed
         */
