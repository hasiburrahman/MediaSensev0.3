...
public class Storer implements BaseFutureListener<FutureDHT>, FuturePrimitive
{
	...
	public Storer(String _key, Serializable _data)
	{
		datakey = _key;
		data = _data;
	...
	@SuppressWarnings("unchecked")
	public Storer startSynchronousRegistration()
	{
		Data _data;
		try {
