...
public class Query implements BaseFutureListener<FutureDHT>, FuturePrimitive
{
	...
	public Query(String _key, Serializable _data)
	{
		datakey = _key;
		data = _data;
	...
	@SuppressWarnings("unchecked")
	public Query startSynchronousRegistration()
	{
		Data _data;
		try {
